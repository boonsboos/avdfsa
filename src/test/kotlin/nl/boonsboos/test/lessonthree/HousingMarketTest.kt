package nl.boonsboos.test.lessonthree

import nl.boonsboos.lessonthree.*
...
class HousingMarketTest {
    ...
    fun `energyFactor of terraced house should be 11 (Double)`() {
        ...
        // act
        val eFactor = house.type.getEnergyCost()
        // assert
        assertEquals(11, eFactor)
    }

    @Test
    fun `getMonthlyPayments of terraced house from 100m2 and area 200m2 should be 17100 divided by 12`() {
        // arrange
        val house = House("", 100, 300000, HousingType.TERRACED, 200)
        // act
        val monthlyPayments = house.getMonthlyPayments()
        // assert: (0,04 * 300.000 + 0,01 * 300.000 + 11 * 100 + 5 * 200) / 12 = 17.100 / 12
        assertEquals(17100 / 12, monthlyPayments)
    }
